...
class Customer_WorkFlow:
    ...
    '''
        confirm quote and cancel quote
    '''
    ...
    '''
        confirm delivered and cancel delivered
    '''
    ...
    #     is_valid = self.page.locator(".form-label").evaluate("el => el.validity.valid")
    ...
    def assert_status_should_change_to_delivered(self):
        expect(self.page.get_by_text("DELIVERED").first).to_have_text("DELIVERED")
        expect(self.page.get_by_text("DELIVERED").nth(1)).to_have_text("DELIVERED")
